          ...
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">dekpras22@gmail.com</p>
                <p class="text-gray-500">081 345 678 567</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                <p class="font-bold mb-1">Intagram</p>
                <p class="text-gray-500">@ayumaas_</p>
                <p class="text-gray-500">083 114 044 502</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex align-start">
              ...
              <div class="grow ml-6">
                <p class="font-bold mb-1">Twitter</p>
                <p class="text-gray-500">@arikusuma123</p>
                <p class="text-gray-500">085 456 324 543</p>
              </div>
            </div>
          </div>
                    <path fill="currentColor"
